...
import 'package:first_app/ui/reclamation/listRecTech.dart';
...
class _HomeTechState extends State<HomeTech> {
  ...
  Container _themeTech(var size, BuildContext context) {
                                  ...
                                  builder: (ctx) =>
                                      StreamProvider<List<Reclamations>>.value(
                                          value: FirestoreServices()
                                              .getRecTech(user: widget.user),
                                          initialData: [],
                                          child: ReclmationTech(
                                              user: widget.user))));
                            } else {
