...
class RecArchive extends StatefulWidget {
  UserData user;
  RecArchive({this.user});
  @override
  _RecArchiveState createState() => _RecArchiveState();
}

UserData useru;

class _RecArchiveState extends State<RecArchive> {
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text('Réclamations Archivées'),
